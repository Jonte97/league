      ...
      <td>
        <div>
          ...
          <img
            ...
            alt="ranked-emblem"
            title={props.player.ranked.solo.tier + " " + props.player.ranked.solo.rank}
          />
        </div>
      </td>
      <td>
        <div className="overview-kda">{`${props.player.kda.toFixed(2)} Kda`}</div>
        <div>
          {`${props.player.stats.kills} / ${props.player.stats.deaths} / ${props.player.stats.assists}`}
        </div>
      </td>
      <td>
        {props.player.stats.neutralMinionsKilled + props.player.stats.totalMinionsKilled}
