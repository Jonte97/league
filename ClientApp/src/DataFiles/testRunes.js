        ...
        runes: [
          {
            ...
            shortDesc:
              "<b>Unique</b> <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>takedowns</lol-uikit-tooltipped-keyword> grant permanent <lifesteal>Omnivamp</lifesteal>. ",
            longDesc:
              "<lifeSteal>Omnivamp</lifeSteal>: 1% + 2% per <i>Bounty Hunter</i> stack. <br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion.<br><br><rules>Omnivamp is only 33% effective when dealing area of effect damage or damage through pets.</rules>",
          },
          {
            id: 8134,
            key: "IngeniousHunter",
            ...
            longDesc:
              "Gain 10 <b>Item Haste</b> plus an additional 5 Item Haste per <i>Bounty Hunter</i> stack (includes Trinkets).<br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion.<br><br><rules>Item Haste affects all items with cooldowns. </rules>",
          },
          {
            id: 8105,
            ...
            longDesc:
              "Gain 5 <b>out of combat Movement Speed</b> plus 8 per <i>Bounty Hunter</i> stack.<br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion.",
          },
          {
            id: 8106,
            key: "UltimateHunter",
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            longDesc:
              "You get free Slightly Magical Footware at 12 min, but you cannot buy boots before then. For each takedown you acquire the boots 45s sooner.<br><br>Slightly Magical Footware grant you an additional <speed>10 Move Speed</speed>.",
          },
          {
            id: 8313,
            key: "PerfectTiming",
        ...
        runes: [
          {
            ...
            name: "Cosmic Insight",
            shortDesc: "+15 Summoner Spell Haste<br>+10 Item Haste",
            longDesc: "+15 Summoner Spell Haste<br>+10 Item Haste",
          },
          {
            id: 8410,
          ...
          },
          {
            ...
            longDesc:
              "Consuming a potion or biscuit grants 50% of its health or mana restoration immediately. In addition, gain 5% Movement Speed while under their effects.<br><br>",
          },
        ],
      },
    ],
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            longDesc:
              "Gain 0.6% lifesteal for every <i>Legend</i> stack (<statGood>max 15 stacks</statGood>).<br><br>Earn progress toward <i>Legend</i> stacks for every champion takedown, epic monster takedown, large monster kill, and minion kill.",
          },
        ],
      },
      {
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            name: "Revitalize",
            shortDesc:
              "Gain <attention>%i:scaleHealShield% 5%</attention> Heal and Shield Power.<br><br>Heals and shields you cast or receive are 10% stronger on targets below 40% health.",
            longDesc:
              "Gain <attention>%i:scaleHealShield% 5%</attention> Heal and Shield Power.<br><br>Heals and shields you cast or receive are 10% stronger on targets below 40% health.",
          },
          {
      ...
      },
      {
        runes: [
          ...
          },
          {
            ...
            longDesc:
              "After casting a Summoner Spell, gain a movement speed increase that lasts for 2s and allows you to pass through units.<br><br>Increase: 5% - 35% Movement Speed based on the Summoner Spell's cooldown. (Higher cooldown Summoner Spells grant more Movement Speed). ",
          },
        ],
      },
      {
